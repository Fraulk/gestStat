 ...
 */
final class Version20181210084808 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE departement (id INT AUTO_INCREMENT NOT NULL, dep_code VARCHAR(255) NOT NULL, dep_nom VARCHAR(255) NOT NULL, dep_chefvente VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
